# Using the `status-scope-dmr` Agent in Copilot Chat
...
To use the agent, type `@status-scope-dmr` followed by your request in the Copilot Chat panel.

The agent uses its knowledge of the three workspace locations:

* DMR plugins
* Bigcore `core_analyzer`
* Framework package

This allows it to help with plugin creation, debugging, configuration, adapter updates, and project-specific development tasks.
